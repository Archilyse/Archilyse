...
import {
  OpeningHeightsInputForm,
  PropertyCheckbox,
  PropertyColor,
  PropertyEnum,
  PropertyEnumLengthMeasure,
  PropertyHidden,
...
export default class Catalog {
  constructor(unit = UNIT_CENTIMETER) {
    ...
    this.registerMultiplePropertyType([
      ...
      ['enum-length-measure', PropertyEnumLengthMeasure, PropertyEnumLengthMeasure],
      ...
      ['opening_heights', OpeningHeightsInputForm, OpeningHeightsInputForm],
