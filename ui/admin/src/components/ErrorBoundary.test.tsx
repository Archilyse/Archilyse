...
describe('handleNetworkError', () => {
  ...
  it('Shows a message to the user on a validation (4xx) error', () => {
    const EXPECTED_ERROR_MESSAGE = 'Nasty error on the form: Better fix it\n';
    const context = { show: jest.fn() };
    const error = {
      response: { status: 422, data: { errors: { json: { 'Nasty error on the form': ['Better fix it'] } } } },
    };
